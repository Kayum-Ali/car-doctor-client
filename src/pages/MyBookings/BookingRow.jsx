...
// -----------------------------------
      ...
      <td className="px-2 py-4 text-sm text-center font-medium text-gray-700 whitespace-nowrap">
            <button onClick={()=> handleDelete(_id)} className="btn btn-circle "> <RxCross1></RxCross1></button>
            <button  className="btn btn-circle ml-5">   <FaEdit></FaEdit></button>
         
      </td>
      <td className="px-2 py-2">
                  <img className="lg:w-40 w-[90px] h-[70px]  md:w-28 lg:h-32  md:h-24 rounded-xl" src={img} alt=""/>
      ...
      <td className="px-2 py-4 text-sm text-gray-500  whitespace-nowrap">{price}</td>
